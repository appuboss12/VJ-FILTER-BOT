...
# Bot information
SESSION = environ.get('SESSION', 'MovieHobbies')
...
PICS = (environ.get('PICS', 'https://envs.sh/9FF.jpg https://envs.sh/9Ft.jpg https://envs.sh/9Fq.jpg https://envs.sh/9pd.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6662808885').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002430859401'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002459964136').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002270083373') # give your force subscribe channel id here else leave it blank
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002468734761')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://kumar8088250:co8ITEzNNY9grjKU@cluster0.bu6jf.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "techvjclonefilterbot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Movie_Hobbies')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Movie_Hobbies1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Movie_Hobbies')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Movie_Hobbies_support') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Movie_Hobbies')
...
SHORTLINK_API = environ.get('SHORTLINK_API', '18ed4a3810dda2c8a07ae586d0e4b73c256508ed')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_to_link_open_z/5') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
